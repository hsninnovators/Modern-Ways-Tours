...
('image', 'Kiwai Adventure Stop', 'assets/images/kiwai.jpg', 'A beautiful refreshing stop for tea, photography and waterfall views.', 5),
('image', 'Lake Boating Moment', 'assets/images/saifulmalook.jpg', 'A premium lake experience with mountain reflections and optional photography.', 6),
('image', 'Babusar Mountain Road', 'assets/images/babusar.jpg', 'Dramatic mountain route views on the way to Babusar Top and Giti Das.', 7),
('image', 'Shogran Bonfire Night', 'assets/images/shogran.jpg', 'Evening hotel stay atmosphere with music, bonfire and group memories.', 8),
('video', 'Naran Tour Highlights', 'https://www.youtube.com/embed/dQw4w9WgXcQ', 'Replace this sample embed from admin with your official tour highlight video.', 9),
('video', 'Adventure Activities Reel', 'https://www.youtube.com/embed/dQw4w9WgXcQ', 'Use this slot for rafting, zipline, boating, horse riding or bonfire video content.', 10);
